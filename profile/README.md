...
```mermaid
flowchart LR
    A[Launch Silksong] --> B[Trainer Attach]
    B --> C{Module Toggle}
    C -->|Combat| D[Health / Damage Control]
    C -->|Movement| E[Jump / Dash Logic]
    C -->|World| F[Speed / Teleport]
    D & E & F --> G[Live Gameplay Adjustment]
```
